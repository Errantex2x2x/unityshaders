Shader "Custom/Cg Toon Surface" 
{
        Properties 
        {
                ...
                _HiddenColor("Hidden Color", Color) = (1.0,0.0,0.0,1.0)
        ...
        SubShader 
        {
                ...
                Pass //Hidden pass, to show culled objects
                {
                        Name "Hidden"

                        Cull Front
                        ZWrite Off		// Do not write on z-buffer
                ...
                {
                		// Compress range from -1,1  to 0,1
                        ...
                        // Sample specular from texture using my custom made UV
                        half3 specularColor = tex2D(_SpecularRamp, half2(specularComponent, 0.0)) * _LightColor0.rgb;
                        // Sample diffuse from texture using my custom made UV
